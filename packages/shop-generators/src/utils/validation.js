...
const VUE_RESERVED_NAMES = [
  'Component', 'Transition', 'TransitionGroup', 'KeepAlive', 'Suspense',
  'Teleport', 'Fragment', 'Text', 'Comment', 'Static'
];
 ...
 */
const HTML_ELEMENTS = [
  'div', 'span', 'p', 'a', 'img', 'form', 'input', 'button', 'header',
...
export function validatePageName(name) {
  ...
  const reservedRoutes = [
    'api', 'admin', 'www', 'mail', 'ftp', 'localhost', 'assets', 'static',
    'config', 'dashboard', 'login', 'logout', 'register', 'profile'
  ];
