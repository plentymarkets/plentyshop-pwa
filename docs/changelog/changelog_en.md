...
- We now require an PWA Security Token to make requests to the plentysystems API. [setup guide](https://pwa-docs.plentymarkets.com/guide/setup/deployment#system-token)
