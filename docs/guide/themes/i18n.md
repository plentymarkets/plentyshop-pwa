...
::: info
The localization editor don't support arrays, so all translation values must be strings or objects. If you have an array in your translation file, it will not be editable in the localization editor.
:::
