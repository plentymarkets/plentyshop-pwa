...
The shop provides a pre-defined layout for the homepage. You provide the data to fill this layout.
...
The shop only uses the template of the homepage category. You don't have to update any of the category's other settings.
:::
