<template>
  <header ref="referenceRef" v-z-layer="'sticky'" :class="headerClass" class="relative w-full @md:sticky @md:shadow-md">
    <div
      ...
      <ul class="flex flex-wrap px-6 py-2 bg-white border-b border-b-neutral-200 border-b-solid" @focusout="onNavBlur">
        ...
        <li v-for="(menuNode, index) in categoryTree" v-else :key="index" @mouseenter="onCategoryMouseEnter(menuNode)">
          ...
          <div
            ...
            class="hidden @md:grid gap-x-6 grid-cols-4 bg-white shadow-lg p-6 pt-5 left-0 right-0 outline-none max-h-[calc(100vh-300px)] overflow-y-auto"
