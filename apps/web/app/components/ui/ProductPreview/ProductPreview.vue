<template>
  <UiButton variant="secondary" aria-label="Produktvorschau" size="sm" class="min-w-[144px] mb-2" @click="open = true">
    <SfIconInfo /> Vorschau
  </UiButton>
  ...
  >
    ...
    >
      ...
      <div class="p-5 px-10 mb-5 overflow-x-auto h-[90vh]">
        <!-- Beschreibung -->
        <VariationBulletPoints v-if="props.product" :fallback="''" :product="props.product" language="de" />
      </div>
    </SfDrawer>
  </transition>
</template>
