            ...
            <template v-if="key === 'quantityAndAddToCart' && configuration?.fields.quantityAndAddToCart">
              ...
              <div class="mt-4">
                ...
                <template v-if="showPayPalButtons">
                  <PayPalExpressButton type="SingleItem" location="itemPage" class="mt-4" @validation-callback="paypalHandleAddToCart" />
                  <PayPalPayLaterBanner placement="product" location="itemPage" :amount="priceWithProperties * quantitySelectorValue" />
                </template>
              </div>
            </template>
