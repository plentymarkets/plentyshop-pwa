<template>
  <div
    ref="rootRef"
    :class="['py-1 z-50 @container/search', props.close ? 'relative' : '']"
  >
...
const dropdownClass = computed(() => {
  const base =
    'z-50 bg-white border-y border-neutral-200 shadow-xl flex flex-col max-h-dropdown @container/dropdown';
  return props.close
