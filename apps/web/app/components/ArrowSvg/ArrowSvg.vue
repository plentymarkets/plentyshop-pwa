<template>
   <SfIconBase viewBox="0 0 91.15 50.12" :class="size + '-eprl-size eprl-arrow' + customClass" data-testid="arrowsvg" v-if="currentArrow">
