<template>
  ...
  >
    <div class="rounded-md">
      <SfAccordionItem v-model="packstationAccordionOpen" :summary-class="accordionSummaryClass">
        <template #summary>
...
import { SfAccordionItem, SfCheckbox, SfIconChevronLeft, SfInput, SfLoaderCircular } from '@storefront-ui/vue';
...
const accordionSummaryClass = computed(() =>
  [
    ...
    packstationAccordionOpen.value ? 'rounded-b-none' : 'rounded-b-md',
  ].join(' '),
);
