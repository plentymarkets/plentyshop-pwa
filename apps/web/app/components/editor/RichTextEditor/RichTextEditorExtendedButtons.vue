<template>
  ...
  <EditorRichTextEditorMenuButton data-testid="rte-align-left" :active="isActiveAlign('left')" icon-name="alignLeft" @click="setAlign('left')" />
  ...
  />
  <EditorRichTextEditorMenuButton data-testid="rte-align-right" :active="isActiveAlign('right')" icon-name="alignRight" @click="setAlign('right')" />
  <EditorRichTextEditorMenuButton data-testid="rte-align-justify" :active="isActiveAlign('justify')" icon-name="block" @click="setAlign('justify')" />
