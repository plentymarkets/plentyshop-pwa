<template>
  <Teleport to="body">
    <SfDrawer
      v-if="open"
      v-model="open"
      class="bg-white border-0 shadow-[inset_0px_0px_20px_-20px_#111] category-drawer !absolute right-0 top-[64px] bottom-0 w-[calc(50vw+25px)] lg:w-[calc(76vw)] pointer-events-auto z-[11]"
      :placement="placement"
      ...
      <div class="p-4">
        <div class="w-full h-[calc(100vh-180px)] overflow-hidden border rounded-lg">
          <div class="relative h-full">
            <div class="flex border-b sticky top-0 z-20 bg-white">
            ...
            <div class="flex overflow-hidden" style="height: calc(100% - 52px)">
              <div ref="leftScroll" class="flex-shrink-0 scrollbar-thin overflow-y-auto sticky left-0 z-20 bg-white">
