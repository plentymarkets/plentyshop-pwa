<template>
  <div>
    ...
    >
      ...
      <div>
        <EditorRichTextEditorForm :modelValue="newsletterBlock.text.htmlDescription ?? ''" @update:modelValue="newsletterBlock.text.htmlDescription = $event" :text-align="'center'">
          <div class="mb-6">
