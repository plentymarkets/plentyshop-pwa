<template>
  <div>
    <EditorFormPanel v-model="textSettings" :title="getEditorTranslation('text-settings-label')" data-testid="item-text-settings">
    ...
    <EditorFormPanel v-model="layoutSettings" :title="getEditorTranslation('layout-settings-label')" data-testid="item-text-layout">

      <div class="flex justify-between my-5">
        <span>{{ getEditorTranslation('display-as-collapsable') }}</span>
        <span>
          <SfSwitch v-model="isCollapsible" data-testid="item-text-displayAsCollapsable-switch" />
        </span>
      </div>
