  ...
  <div>
    ...
    >
      ...
      <div class="flex justify-between my-5">
        ...
        <span>
          <SfSwitch v-model="itemTextBlock.displayAsCollapsable" data-testid="item-text-displayAsCollapsable-switch" />
        </span>
      </div>
      ...
      <div class="flex justify-between">
        ...
        <span>
          <SfSwitch v-model="itemTextBlock.initiallyCollapsed" data-testid="item-text-initiallyCollapsed-switch" />
        </span>
      </div>
