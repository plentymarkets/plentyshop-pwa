      ...
      <ClientOnly>
        <button
          ...
          :class="[
            ...
            'group-hover/block:opacity-100 group-hover/block:scale-100 group-focus-within/block:opacity-100 group-focus-within/block:scale-100 focus-visible:opacity-100 focus-visible:scale-100',
            {
      ...
      <ClientOnly>
        <button
          ...
          :class="[
            ...
            'group-hover/block:opacity-100 group-hover/block:scale-100 group-focus-within/block:opacity-100 group-focus-within/block:scale-100',
            {
              '!opacity-100 !scale-100':
