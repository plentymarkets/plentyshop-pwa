...
const content: HomepageContent = {
  carousel: {
    banner1: {
      ...
      buttonLabel: 'Capybara entdecken',
    },
    banner2: {
  ...
  multigrid: {
    textcard: {
      ...
      buttonLabel: 'Zu unseren Kopfhörern',
    },
    image: {
      alt: 'Kopfhörer',
    },
  ...
  productRecommended: {
    fashion: {
      ...
      description:
        "<a class='underline' href='https://plentyshop.plentymarkets.com/kleidung' target='_self'>Zu unserer kompletten Kollektion.</a>",
    },
  },
  newsletter: {
...
console.warn('🇩🇪 Loading HOMEPAGE template [DE]:', {
