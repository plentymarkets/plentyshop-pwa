export default {
  ...
  enableGoogleAnalytics: process.env.PWA_MODULE_GA_ENABLED === 'true',
  googleAnalyticsTrackingId: process.env.PWA_MODULE_GA_ID || '',
  sendGrossPricesToGoogleAnalytics: process.env.PWA_MODULE_GA_SHOW_GROSS_PRICES === 'true',
  googleAnalyticsCookieGroup: process.env.PWA_MODULE_GA_COOKIE_GROUP || 'CookieBar.marketing.label',
  registerCookieAsOptOut: process.env.PWA_MODULE_GA_OPT_OUT === 'true',
