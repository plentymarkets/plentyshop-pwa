...
export const useAddressForm = (type: AddressType, address?: Address) => {
    ...
    const createAddressForm = (type: AddressType, address?: Address) => {
        const { t } = useI18n();
    ...
    const instance = createAddressForm(type, address);
