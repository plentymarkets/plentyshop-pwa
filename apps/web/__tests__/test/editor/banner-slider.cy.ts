...
class BannerSliderObject extends PageObject {
  ...
  changeBannerImage(){
    cy.get('[data-testid="slide-4xl-image-input"]').should('be.visible').clear().type("https://cdn02.plentymarkets.com/v5vzmmmcb10k/frontend/PWA/placeholder-image.png", { delay: 0 });
    cy.get('[data-testid="slide-desktop-image-input"]').should('be.visible').clear().type("https://cdn02.plentymarkets.com/v5vzmmmcb10k/frontend/PWA/placeholder-image.png", { delay: 0 });
  }

  checkNewBannerImage(){
    cy.get('[data-testid="banner-image-0"]').should('be.visible');
    cy.get('[data-testid="banner-image-0"]').should('have.attr', 'src', 'https://cdn02.plentymarkets.com/v5vzmmmcb10k/frontend/PWA/placeholder-image.png');
  }
  ...
  alignBoxCenterX(){
    ...
    cy.get('[data-testid="banner-overlay-0"]')
