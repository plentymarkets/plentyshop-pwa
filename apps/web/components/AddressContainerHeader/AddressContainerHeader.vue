<template>
  <div class="flex md:items-center flex-col md:flex-row justify-between mb-4">
    ...
    <div>
      <AddressSelect @edit="emit('edit', $event)" :type="type" />
...
import { AddressContainerHeaderEvents, AddressContainerHeaderProps  } from './types';
...
const emit = defineEmits<AddressContainerHeaderEvents>();
</script>
