  ...
  <div v-if="block.meta" :key="block.meta.uuid" :class="{ 'drag-handle cursor-move': root }">
    ...
    >
      <button
        ...
        class="add-block-button transition-opacity duration-200 z-[0] md:z-[1] lg:z-[10] absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-[18px] p-[6px] bg-[#538aea] text-white opacity-0 hover:opacity-100 group-hover:opacity-100 group-focus:opacity-100"
