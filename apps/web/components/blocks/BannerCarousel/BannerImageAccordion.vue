<template>
  <UiAccordionItem v-model="localOpen" summary-active-class="bg-neutral-100"
    ...
    <div class="images">
      <div class="mb-6 mt-4">
        <label>
          ...
          <SfInput v-model="localImage.wideScreen" data-testid="slide-4xl-image-input" type="text"
      ...
      <div class="mb-6">
        <label>
          ...
          <SfInput v-model="localImage.desktop" data-testid="slide-desktop-image-input" type="text"
            placeholder="Enter URL of image" />
          <div class="typography-text-xs text-gray-500 flex gap-1 mt-2 sm:mb-0">
      ...
      <div class="mb-6">
        ...
        <div class="flex items-center gap-4">
          <div class="flex-1 space-y-1">
            ...
            <input v-model.number="localImage.brightness" type="range" min="0" max="1" step="0.01" class="w-full"
              @input="emitClampBrightness($event, 'image')" />
          </div>

          <div class="relative">
            <input v-model.number="localImage.brightness" type="number" min="0" max="1"
              class="w-20 px-2 py-1 border rounded text-color-red-500" @input="emitClampBrightness($event, 'image')" />
          </div>
        </div>
      </div>
