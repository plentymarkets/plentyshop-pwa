  ...
  <UiAccordionItem v-model="textOpen" summary-active-class="bg-neutral-100"
    ...
    <div>
      <div class="mb-6">
        ...
        <SfInput v-model="banner.content.text.pretitle" name="preTitle" type="text" placeholder="PreTitle"
          data-testid="banner-input-pre-title" />
      </div>

      <div class="mb-6">
        <UiFormLabel class="mb-1">Main title</UiFormLabel>
        <SfInput v-model="banner.content.text.title" name="mainTitle" type="text" placeholder="Title"
          data-testid="banner-input-title" />
      </div>

      <div class="mb-6">
        <UiFormLabel class="mb-1">Subtitle</UiFormLabel>
        <SfInput v-model="banner.content.text.subtitle" name="subtitle" type="text" placeholder="SubTitle"
          data-testid="banner-input-sub-title" />
      </div>

      <div class="mb-6">
        <UiFormLabel class="mb-1">Description</UiFormLabel>
        <SfTextarea v-model="banner.content.text.htmlDescription" name="description"
      ...
      <div class="mb-6">
        ...
        <SfInput v-model="banner.content.text.color" type="text">
          <template #suffix>
            <label for="text-color" :style="{ backgroundColor: banner.content.text.color }"
      ...
      <div class="mb-6">
        ...
        <SfSwitch v-model="banner.content.text.background"
      ...
      <div v-if="banner.content.text.background" class="mb-6">
        ...
        <SfInput v-model="banner.content.text.bgcolor" type="text">
          <template #suffix>
            <label for="text-bg-color" :style="{ backgroundColor: banner.content.text.bgcolor }"
              class="border border-[#a0a0a0] rounded-lg cursor-pointer">
      ...
      <div v-if="banner.content.text.background" class="mb-6">
        ...
        <div class="flex items-center gap-4">
          <div class="flex-1 space-y-1">
            ...
            <input v-model.number="banner.content.text.bgopacity" @input="emitClampBrightness($event)" type="range" min="0" max="1" step="0.01"
              class="w-full" />
          </div>
          <div class="relative">
            <input v-model.number="banner.content.text.bgopacity" type="number" min="0" max="1"
      ...
      <div class="mb-6">
        ...
        <div class="mt-2 w-full inline-flex rounded-lg border border-gray-300 bg-white text-gray-700 overflow-hidden">
          ...
          }" data-testid="slider-textbox-align-top" @click="banner.content.text.justify = 'top'">
          ...
          }" data-testid="slider-textbox-align-center" @click="banner.content.text.justify = 'center'">
          ...
          }" data-testid="slider-textbox-align-bottom" @click="banner.content.text.justify = 'bottom'">
            <SfIconCheck class="mr-1 w-[1.1rem]"
      ...
      <div class="mb-6">
        ...
        <div class="mt-2 w-full inline-flex rounded-lg border border-gray-300 bg-white text-gray-700 overflow-hidden">
          ...
          }" data-testid="slider-textbox-y-align-left" @click="banner.content.text.align = 'left'">
          ...
          }" data-testid="slider-textbox-y-align-center" @click="banner.content.text.align = 'center'">
          ...
          }" data-testid="slider-textbox-y-align-right" @click="banner.content.text.align = 'right'">
      ...
      <div class="mb-6">
        ...
        <div class="mt-2 w-full inline-flex rounded-lg border border-gray-300 bg-white text-gray-700 overflow-hidden">
          ...
          }" data-testid="slider-text-align-left" @click="banner.content.text.textAlignment = 'left'">
            <SfIconCheck class="mr-1 w-[1.1rem]"
          ...
          }" data-testid="slider-text-align-right" @click="banner.content.text.textAlignment = 'right'">
            <SfIconCheck class="mr-1 w-[1.1rem]"
