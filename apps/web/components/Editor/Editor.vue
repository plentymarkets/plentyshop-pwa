<template>
  ...
  /></SfButton>
<!--  <div v-if="props.block?.name === 'NewsletterSubscribe'">-->
<!--    <NewsletterSubscribeEditor/>-->
<!--  </div>-->
<!--  <div v-else class="mx-auto p-5">-->
...
const getComponent = (name: string) => {
  if (name === 'NewsletterSubscribe') return resolveComponent('NewsletterSubscribeEditor');
};
</script>
