<template>
<div
  class="p-2 absolute left-0 top-full mt-2 bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden w-auto min-w-max h-[300px]"
>
...
<!--  <div>-->
<!--    <ul v-if="filteredPages.length > 0" class="p-2 transition-all duration-300 max-h-[300px] w-auto min-w-max overflow-y-auto">-->
...
const { t } = useI18n();
// const filteredPages = ref<{ name: string; path: string }[]>([]);
