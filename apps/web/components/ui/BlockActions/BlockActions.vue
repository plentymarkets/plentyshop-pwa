<template>
  ...
  >
    <button class="text-black hover:bg-gray-100 p-1 rounded" data-testid="open-editor-button" aria-label="editor button" @click="triggerEdit">
    ...
    <button class="text-black hover:bg-gray-100 p-1 rounded" aria-label="aria label" data-testid="delete-block-button" @click="triggerDelete">
      <SfIconDelete />
    </button>
  </div>
</template>
