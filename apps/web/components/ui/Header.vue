        ...
        >
          <template #prefix>
            ...
            <SfBadge
              ...
              class="outline outline-primary-500 bg-white !text-neutral-900 group-hover:outline-primary-800 group-active:outline-primary-700 flex justify-center text-[12px] leading-[12px] min-w-[16px] min-h-[16px]"
