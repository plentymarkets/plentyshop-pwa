...
import { useCategoryTree, useCustomer, useLoginModal } from '~/composables';
...
const { isOpen: isAuthenticationOpen, close: closeAuthentication, open: openAuthentication } = useLoginModal();
