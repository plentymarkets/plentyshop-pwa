...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      seoRichSnippetBrandId: process.env.NUXT_PUBLIC_ROBOTS_ITEM_PAGE || '1',
      ...
      seoRichSnippetBarcodeGtinId: process.env.NUXT_PUBLIC_SEO_RICH_SNIPPET_BARCODE_GTIN_ID || '1',
      seoRichSnippetBarcodeGtin8: process.env.NUXT_PUBLIC_SEO_RICH_SNIPPET_BARCODE_GTIN8 || '1',
      seoRichSnippetBarcodeGtin8Id: process.env.NUXT_PUBLIC_SEO_RICH_SNIPPET_BARCODE_GTIN8_ID || '1',
      seoRichSnippetBarcodeGtin13: process.env.NUXT_PUBLIC_SEO_RICH_SNIPPET_BARCODE_GTIN13 || '1',
      seoRichSnippetBarcodeGtin13Id: process.env.NUXT_PUBLIC_SEO_RICH_SNIPPET_BARCODE_GTIN13_ID || '1',
      seoRichSnippetBarcodeIsbn: process.env.NUXT_PUBLIC_SEO_RICH_SNIPPET_BARCODE_ISBN || '1',
      seoRichSnippetBarcodeIsbnId: process.env.NUXT_PUBLIC_SEO_RICH_SNIPPET_BARCODE_ISBN_ID || '1',
      seoRichSnippetMpnBarcode: process.env.NUXT_PUBLIC_SEO_RICH_SNIPPET_MPN_BARCODE || '1',
      seoRichSnippetMpnBarcodeId: process.env.NUXT_PUBLIC_SEO_RICH_SNIPPET_MPN_BARCODE_ID || '1',
      ...
      seoRichSnippetSkuBarcodeId: process.env.NUXT_PUBLIC_SEO_RICH_SKU_BARCODE_ID || '1',
