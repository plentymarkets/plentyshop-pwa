...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      categoryRobotsNoIndex: process.env.NUXT_PUBLIC_CATEGORY_ROBOTS_NO_INDEX || 'all',
      itemRobots: process.env.NUXT_PUBLIC_ITEM_ROBOTS || 'all',
      itemConditionNew: process.env.NUXT_PUBLIC_ITEM_CONDITION_NEW || 'https://schema.org/NewCondition',
      itemConditionUsed: process.env.NUXT_PUBLIC_ITEM_CONDITION_USED || 'https://schema.org/NewCondition',
      itemConditionNewAndOriginalPacking: process.env.NUXT_PUBLIC_ITEM_NEW_AND_ORIGINAL_PACKING || 'https://schema.org/NewCondition',
      itemConditionNewWithLabel: process.env.NUXT_PUBLIC_ITEM_CONDITION_NEW_WITH_LABEL || 'https://schema.org/NewCondition',
      itemConditionBstock: process.env.NUXT_PUBLIC_ITEM_CONDITION_BSTOCK || 'https://schema.org/NewCondition',
      seoAvailability1: process.env.NUXT_PUBLIC_ITEM_SEO_AVAILABILITY || 'In stock',
      seoAvailability2: process.env.NUXT_PUBLIC_ITEM_SEO_AVAILABILITY || 'In stock',
      seoAvailability3: process.env.NUXT_PUBLIC_ITEM_SEO_AVAILABILITY || 'In stock',
      seoAvailability4: process.env.NUXT_PUBLIC_ITEM_SEO_AVAILABILITY || 'In stock',
      seoAvailability5: process.env.NUXT_PUBLIC_ITEM_SEO_AVAILABILITY || 'In stock',
      seoAvailability6: process.env.NUXT_PUBLIC_ITEM_SEO_AVAILABILITY || 'In stock',
      seoAvailability7: process.env.NUXT_PUBLIC_ITEM_SEO_AVAILABILITY || 'In stock',
