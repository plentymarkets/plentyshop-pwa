...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      showNotifyMe: process.env.ENABLE_NOTIFY_ME ? process.env.ENABLE_NOTIFY_ME === 'true' : true, //  process.env.NUXT_PUBLIC_SHOW_NOTIFY_ME ? process.env.NUXT_PUBLIC_SHOW_NOTIFY_ME === 'true' : true,
